...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 px-2 py-2.5 bg-white rounded border-gray-200 sm:px-4 dark:bg-gray-800">
      <div className="container flex justify-between items-center mx-auto">
        ...
        <div className="block w-auto">
          <ul className="flex flex-row mt-0 space-x-8 text-sm md:font-medium">
            <li>
              <a
                href="https://www.github.com/rob4everever"
            ...
            <li>
              <a
                href="https://www.instagram.com/robbatr0n_"
                className="block text-gray-700 bg-transparent"
              >
                <svg
                  className="w-6 h-6 fill-current md:w-8 md:h-8"
            ...
            <li>
              <a
                href="https://www.linkedin.com/barton.rob27"
                className="block text-gray-700 bg-transparent"
              >
                <svg
                  className="w-6 h-6 fill-current md:w-8 md:h-8"
